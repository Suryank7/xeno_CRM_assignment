...
export default function Copilot() {
  ...
  async function handleSaveSegment(audience) {
    try {
      await createSegment({
        name: audience?.segmentName || 'Custom AI Audience',
        description: audience?.description || 'Audience generated by Xeno Pulse AI',
  ...
  async function handleCreateCampaign(plan) {
    try {
      ...
      const segRes = await createSegment({
        name: plan.audience?.segmentName || 'Custom AI Audience',
        description: plan.audience?.description || 'Audience generated by Xeno Pulse AI',
